...
1) **Enter the place title**: Provide a clear, concise name that reflects the essence of the place, or use a commonly accepted or official name.
2) **Upload a quality cover image**: Choose a clear, beautiful cover photo. There should be no people in the foreground of the cover photo; please do not upload images with people or selfies.
3) **Pick the place location**: Indicate the location as accurately as possible to help others find it easily.
4) **Choose categories**: Select up to three categories that best describe your place. [Here you can read the category descriptions](https://help.tripadvancer.com/categories).
5) **Provide a detailed description**: Explain the value and attractiveness of the place so that others understand why it’s worth visiting.
6) **Add up to 10 photos**: This will help enhance the description of the place.
...
<Callout type="warning" emoji="⚠️">
    Do not added duplicates of places that are already in our database. If your place is already added, you can leave a review, rating it, and attach photos.
</Callout>
